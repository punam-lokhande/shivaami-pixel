...
const shivaamiAdvantages = [
  ...
  { icon: Shield, title: "2-Year Warranty — Google + Shivaami", desc: "Every Pixel comes with Google's standard 1-year warranty. Shivaami adds one more year on top, so your devices stay covered, and your investment stays protected.", color: "text-google-yellow", bg: "bg-google-yellow/10" },
