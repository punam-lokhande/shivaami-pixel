      ...
      <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-4">
        ...
        <div>
          ...
          <div className="mt-3 flex flex-col gap-2">
            ...
            <a href="tel:+919022223600" className="text-sm text-muted-foreground hover:text-primary transition-colors">+91 90222 23600</a> className="text-sm text-muted-foreground hover:text-primary transition-colors">+91 90222 23600</a> className="text-sm text-muted-foreground hover:text-primary transition-colors">+91 90222 23600</a>
